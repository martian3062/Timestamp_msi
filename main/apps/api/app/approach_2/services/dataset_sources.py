...
DEFAULT_LOCAL_DATASET_PATH = DEFAULT_WORKSPACE_ROOT / "datasets" / DEFAULT_DATASET_DIRNAME
...
def resolve_local_dataset_path(config: dict[str, Any]) -> str:
    ...
    if source == "workspace_root":
        ...
        workspace_candidates = [
            workspace_root / "datasets" / DEFAULT_DATASET_DIRNAME,
            workspace_root / DEFAULT_DATASET_DIRNAME,
        ]
